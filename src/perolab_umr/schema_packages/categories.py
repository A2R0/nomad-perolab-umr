...
class UMRCreateCategory(EntryDataCategory):
    m_def = Category(label='UMR Create Entries', categories=[EntryDataCategory])

class UMRCollectionCategory(EntryDataCategory):
    m_def = Category(label='Other UMR Classes', categories=[EntryDataCategory])
...
class UMRSynthesisCategory(EntryDataCategory):
    m_def = Category(label='UMR Batch Plan Sections', categories=[EntryDataCategory])
