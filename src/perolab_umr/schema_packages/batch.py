...
from nomad.metainfo import Quantity, SubSection, Section, Reference, Package, MEnum
...
class UMR_Group(Entity, EntryData):
    ...
    display_name = Quantity(
        type=str,
        desrciption='Automatically generated name of group, displayed in SubSections',
    )
